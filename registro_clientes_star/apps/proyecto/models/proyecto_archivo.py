...
class ProyectoArchivo(BaseModel):
    ...
    @property
    def aplicacion_editable(self):
        """
        Indica qué aplicación puede utilizarse
        para abrir el documento en modo edición.
        ...
        extension = self.extension_archivo
        ...
        if extension in extensiones_powerpoint:
            return "powerpoint"

        return None

    @property
    def es_archivo_editable(self):
        """
        Indica si existe una aplicación soportada
        para abrir el archivo en modo edición.
        """

        return bool(
            self.aplicacion_editable
        )
